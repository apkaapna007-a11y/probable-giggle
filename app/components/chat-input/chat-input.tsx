...
import { ModeSelector } from "@/components/common/mode-selector/base"
import {
  PromptInput,
  PromptInputAction,
  PromptInputActions,
...
type ChatInputProps = {
  ...
  onSelectMode: (mode: "clinical" | "academic") => void
  selectedMode: "clinical" | "academic"
...
export function ChatInput({
  ...
  // NelsonGPT doesn't use model-specific search support
          ...
          <PromptInputActions className="mt-3 w-full justify-between p-2">
            <div className="flex gap-2">
              <ButtonFileUpload
                ...
                // NelsonGPT doesn't pass specific model to file upload
              />
              <ModeSelector
